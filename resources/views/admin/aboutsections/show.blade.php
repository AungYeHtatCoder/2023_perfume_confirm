    ...
    <div class="row breadcrumbs-top">
     <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item"><a href="{{ url('/admin/aboutsections/show') }}">Back To About Section</a>
       </li>
       <li class="breadcrumb-item active">About Section Detail Dashboard
       </li>
      </ol>
     </div>
    </div>
  ...
  <div class="col-12">
   <div class="card">
    <div class="card-header">
     <h4 class="card-title">
      <a href="{{ url('/admin/aboutsections') }}" class="btn btn-success btn-round">Back To About Sections</a>
     </h4>
    ...
    <div class="card-content collapse show">
     <div class="card-body card-dashboard">
      <p class="card-text">About Section Show Detail</p>
      <img src="{{ asset('assets/img/aboutsections/'.$section->image) }}" class="w-75" alt="">
      <span class="text-warning d-block mt-3 mb-1">{{ $section->header }}</span>
      <h3 class="text-dark">{{ $section->paragraph }}</h3>
     </div>
    </div>
   </div>
  </div>
