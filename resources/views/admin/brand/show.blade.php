     ...
     <div class="card-body card-dashboard">
      <div class="row justify-content-md-center">
       <div class="col-md-10">
        <div class="card">
         <div class="card-header">
          <h4 class="card-title" id="from-actions-top-bottom-center">Brand Detail</h4>
          <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
          <div class="heading-elements">
           <ul class="list-inline mb-0">
            <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
          ...
          <div class="card-body">
           <table class="table">
            ...
            <tr>
             ...
             <td>{!! $brand_detail->category->brand_category_name !!}</td>

            </tr>
            <tr>
             <th>Brand Logo</th>
             <td><img src="{{ asset('uploads/' . $brand_detail->branch_logo) }}" width="100px" height="100px"
               alt="{{ $brand_detail->brand_name }} Logo" class="brand_logo">
             </td>
            </tr>
            <th>Create Date</th>
