 ...
 <div class="content-header-light col-12">
  <div class="row">
   <div class="content-header-left col-md-9 col-12 mb-2">
    <h3 class="content-header-title">Brand Dashboard</h3>
    <div class="row breadcrumbs-top">
     <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
       <li class="breadcrumb-item"><a href="{{ url('/home') }}">Home</a>
       </li>
       {{-- <li class="breadcrumb-item"><a href="#">Brand  DataTables</a>
       </li> --}}
       <li class="breadcrumb-item active">Brand Dashboard
       </li>
      </ol>
     </div>
    </div>
  ...
  <div class="col-12">
   <div class="card">
    <div class="card-header">
     <h4 class="card-title">
      <a href="{{ route('admin.brands.create') }}" class="btn btn-success btn-round">New Brand Create</a>
     </h4>
      ...
      <table class="table table-striped table-bordered dataex-res-configuration">
       ...
       <tbody>
        ...
        <tr>
         ...
         <td>{{ $brand->category->brand_category_name }}</td>
         <td><img src="{{ asset('uploads/' . $brand->branch_logo) }}" width="50px" alt="{{ $brand->brand_name }} Logo">
         </td>
         <td>{{ $brand->created_at }}</td>
         <td>
          <a href="{{ route('admin.brands.edit', $brand->id) }}" class="btn btn-warning btn-sm">Edit</a>
          <a href="{{ route('admin.brands.show', $brand->id) }}" class="btn btn-primary btn-sm">Show</a>
