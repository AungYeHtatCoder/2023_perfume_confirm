    ...
    <div class="row breadcrumbs-top">
     <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active">Perfume Size Detail Dashboard
       </li>
      </ol>
     </div>
    </div>
    ...
    <div class="card-content collapse show">
     <div class="card-body card-dashboard">
      ...
      <table class="table table-striped table-bordered dataex-res-configuration">
       ...
       <tr>
        <th>Create Date</th>
        <td>{!! $size_detail->created_at->format('F j, Y') !!}</td>
       </tr>
       <tr>
        <th>Update Date</th>
        <td>{!! $size_detail->updated_at->format('F j, Y') !!}</td>
       </tr>
      </table>
