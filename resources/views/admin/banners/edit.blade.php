 ...
 <div class="content-header-light col-12">
  <div class="row">
   <div class="content-header-left col-md-9 col-12 mb-2">
    <h3 class="content-header-title">Banner Update Dashboard</h3>
    <div class="row breadcrumbs-top">
     <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active">Banner Update Dashboard
       </li>
      </ol>
     </div>
    </div>
  ...
  <div class="col-12">
   <div class="card">
    <div class="card-header">
     <h4 class="card-title">
      <a href="{{ url('/admin/banners') }}" class="btn btn-success btn-round">Back To Banner</a>
     </h4>
     ...
     <div class="card-body card-dashboard">
      <div class="row justify-content-md-center">
       <div class="col-md-6">
        <div class="card">
         <div class="card-header">
          <h4 class="card-title" id="from-actions-top-bottom-center">Banner Update</h4>
          <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
          <div class="heading-elements">
           <ul class="list-inline mb-0">
            <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                ...
                <div class="form-body">
                 <div class="row">
                    <div class="form-group col-12 mb-2">
                        ...
                        <img class="mt-1" src="{{ asset('assets/img/banners/'.$banner->image) }}" width="200px" alt="">
                    </div>
                 </div>
                </div>
                <div class="form-body">
                    <div class="row">
                        <div class="form-group col-12 mb-2">
                            ...
                            <input type="text" id="eventInput2" class="form-control" placeholder="Enter Heading Text" name="text_1" value="{{ $banner->text_1 }}">
                            @error('text_1')
                ...
                <div class="form-body">
                    <div class="row">
                        <div class="form-group col-12 mb-2">
                            ...
                            <input type="text" id="eventInput2" class="form-control" placeholder="Enter Header" name="text_2" value="{{ $banner->text_2 }}">
                            @error('text_2')
                ...
                <div class="form-body">
                    <div class="row">
                     <div class="form-group col-12 mb-2">
                      ...
                      <textarea name="text_3" id="" cols="30" rows="5" class="form-control" placeholder="Enter Short Paragraph">{{ $banner->text_3 }}</textarea>
                      @error('text_3')
