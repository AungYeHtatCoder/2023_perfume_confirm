 ...
 <div class="content-header-light col-12">
  <div class="row">
   <div class="content-header-left col-md-9 col-12 mb-2">
    <h3 class="content-header-title">Banner Dashboard</h3>
    <div class="row breadcrumbs-top">
     <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active">Banner Dashboard
       </li>
      </ol>
     </div>
    </div>
     ...
     <div class="card-body card-dashboard">
      ...
      <table class="table table-striped table-bordered dataex-res-configuration">
       ...
       <tbody>
        ...
        <tr>
            <td>{{ ++$key }}</td>
            <td><img src="{{ asset('assets/img/banners/'.$banner->image) }}" width="200px" alt=""></td>
            <td>{{ $banner->text_1 }}</td>
            <td>{{ $banner->text_2 }}</td>
            <td>{{ $banner->text_3 }}</td>
            ...
            <td>
                ...
                <a href="{{ url('/admin/banners/show/'.$banner->id) }}" class="btn btn-primary btn-sm">Show</a>
                <a href="{{ url('/admin/banners/delete/'.$banner->id) }}" class="btn btn-danger btn-sm">Delete</a>
            </td>
        </tr>
        @endforeach
       </tbody>
