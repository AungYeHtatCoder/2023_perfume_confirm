    ...
    <div class="row breadcrumbs-top">
     <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item"><a href="{{ url('/admin/banners/show') }}">Back To Banner</a>
       </li>
       <li class="breadcrumb-item active">Banner Detail Dashboard
       </li>
      </ol>
     </div>
    </div>
   ...
   <div class="card">
    ...
    <div class="card-content collapse show">
     <div class="card-body card-dashboard">
      <p class="card-text">Banner Show Detail</p>
      <img src="{{ asset('assets/img/banners/'.$banner->image) }}" class="img-thumbnail w-75" alt="">
      <span class="text-warning d-block mt-3 mb-1">{{ $banner->text_1 }}</span>
      <h3 class="text-dark">{{ $banner->text_2 }}</h3>
      <p class="text-dark">{{ $banner->text_3 }}</p>
     </div>
    </div>
   </div>
  </div>
