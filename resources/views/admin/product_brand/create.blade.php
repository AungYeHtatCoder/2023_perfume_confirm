  ...
  <div class="col-12">
   <div class="card">
    <div class="card-header">
     <h4 class="card-title">
      <a href="{{ route('admin.product_brands.index') }}" class="btn btn-success btn-round">Back To Our Brand </a>
     </h4>
        ...
        <div class="card">
         ...
         <div class="card-content collpase show">
          <div class="card-body">
           ...
           <form class="form" method="post" action="{{ route('admin.product_brands.store') }}"
            enctype="multipart/form-data">
            @csrf
            <div class="form-body">
             <div class="row">
              <div class="form-group col-12 mb-2">
               <label for="eventInput2">Brand Name</label>
               <input type="text" id="eventInput2" class="form-control" placeholder="Brand Name" name="brand_name">
              </div>
             </div>
             <div class="row">
              <div class="form-group col-12 mb-2">
