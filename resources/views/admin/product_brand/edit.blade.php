  ...
  <div class="col-12">
   <div class="card">
    <div class="card-header">
     <h4 class="card-title">
      <a href="{{ route('admin.product_brands.index') }}" class="btn btn-success btn-round">Back To Brand </a>
     </h4>
        ...
        <div class="card">
         ...
         <div class="card-content collpase show">
          <div class="card-body">
           ...
           <form class="form" method="post" action="{{ route('admin.product_brands.update', $brand_edit['id']) }}"
            ...
            <div class="form-body">
             ...
             <div class="row">
              <div class="form-group col-12 mb-2">
               ...
               @if ($brand_edit->logo)
               <p>Current Logo:</p>
               <img src="{{ asset('uploads/' .$brand_edit->logo) }}" alt="Current Logo" class="img-fluid mb-2">
               @endif
              </div>
             </div>
            </div>
