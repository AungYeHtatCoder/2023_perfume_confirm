    ...
    <div class="row breadcrumbs-top">
     <div class="breadcrumb-wrapper col-12">
      <ol class="breadcrumb">
       ...
       <li class="breadcrumb-item active">Perfume Scent Detail Dashboard
       </li>
      </ol>
     </div>
    </div>
    ...
    <div class="card-content collapse show">
     <div class="card-body card-dashboard">
      ...
      <table class="table table-striped table-bordered dataex-res-configuration">
       <tr>
        <th>ID</th>
        <td>{!! $scent_detail->id !!}</td>
       </tr>
       <tr>
        <th>Scent</th>
        <td>
         {!! $scent_detail->scent_name !!}
        </td>
       </tr>
       <tr>
        <th>Create Date</th>
        <td>{!! $scent_detail->created_at->format('F j, Y') !!}</td>
       </tr>
       <tr>
        <th>Update Date</th>
        <td>{!! $scent_detail->updated_at->format('F j, Y') !!}</td>
       </tr>
      </table>
