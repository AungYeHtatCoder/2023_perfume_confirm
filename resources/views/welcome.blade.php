    ...
    <div class="row">
     ...
     <div class="col-lg-12">
      ...
      <div class="pd-detail">
       ...
       <div class="u-s-m-b-15">
        <div class="pd-detail__inline">
         @if ($size->pivot->discount_price <= 0 || NULL) <span class="pd-detail__price">
          {{ number_format($size->pivot->normal_price) }} MMK</span>
          @else
          ...
          @if ($size->pivot->qty <= 0 || NULL) <span class="pd-detail__left">Out Of Stock</span>
           @else
             ...
             <div class="pd-detail-inline-2">
              <div class="u-s-m-b-15">
               ...
               <div class="input-counter">
                ...
                <input class="input-counter__text input-counter--text-primary-style" name="qty" type="text" value="1"
...
<div class="modal fade" id="quick-look-top-trending-{{ $product->id }}">
 <div class="modal-dialog modal-dialog-centered">
  <div class="modal-content modal-content-lg modal--shadow">
   <button class="btn dismiss-button fas fa-times" type="button" data-dismiss="modal"></button>
   <div class="modal-body">
...
@foreach ($topTrending as $product)
<div class="modal fade" id="cart-top-trending-{{ $product->id }}">
 <div class="modal-dialog modal-dialog-centered">
  <div class="modal-content modal-radius modal-shadow">
