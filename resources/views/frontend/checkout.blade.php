       ...
       <form class="checkout-f__delivery">
        <div class="u-s-m-b-30">
         ...
         <div class="u-s-m-b-15">
          ...
          <input class="input-text input-text--primary-style" type="text" id="billing-street"
         ...
         <div class="u-s-m-b-15">
          ...
          <input class="input-text input-text--primary-style" type="text" id="billing-street-optional"
          ...
          <div class="o-card">
           <div class="o-card__flex">
            <div class="o-card__img-wrap">
             ...
             <img class="u-img-fluid" src="{{ asset('user_app/assets/images/product/electronic/product_23.jpg')}}"
              alt="">
            </div>
            <div class="o-card__info-wrap">
         ...
         <div class="o-summary__box">
          ...
          <form class="checkout-f__payment">
           <div class="u-s-m-b-10">
            ...
            <span class="gl-text u-s-m-t-6">Pay Upon Cash on delivery. (This service is only available for some
             countries)</span>
           </div>
           <div class="u-s-m-b-10">
