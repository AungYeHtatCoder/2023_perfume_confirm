          ...
          <div class="row">
           <div class="col-lg-6 col-md-6 u-h-100">
            <div class="u-s-m-b-30">
             ...
             <input class="input-text input-text--border-radius input-text--primary-style" type="text" id="c-name"
            ...
            <div class="u-s-m-b-30">
             ...
             <input class="input-text input-text--border-radius input-text--primary-style" type="text" id="c-email"
            ...
            <div class="u-s-m-b-30">
             ...
             <input class="input-text input-text--border-radius input-text--primary-style" type="text" id="c-subject"
           ...
           <div class="col-lg-6 col-md-6 u-h-100">
            <div class="u-s-m-b-30">
             ...
             <label for="c-message"></label><textarea
              class="text-area text-area--border-radius text-area--primary-style" id="c-message"
