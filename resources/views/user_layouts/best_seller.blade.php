    ...
    <div class="row">
     <div class="col-lg-12">
      <div class="section__text-wrap">
       ...
       <span class="section__span u-c-silver">Start your day with fresh</span>
      </div>
     </div>
    </div>
   </div>
      ...
      <div class="bp-mini bp-mini--img u-h-100">
       <div class="bp-mini__thumbnail">
        ...
        <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block" href="blog-detail.html">
         ...
         <img class="aspect__img" src="{{ asset('user_app/assets/images/blog/post_2.jpg')}}" alt=""></a>
        <!--====== End - Image Code ======-->
       </div>
       <div class="bp-mini__content">
        ...
        <div class="blog-t-w">
         ...
         <a class="gl-tag btn--e-transparent-hover-brand-b-2">View</a>

         <a class="gl-tag btn--e-transparent-hover-brand-b-2">Add to cart</a>
      ...
      <div class="bp-mini bp-mini--img u-h-100">
       <div class="bp-mini__thumbnail">
        ...
        <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block" href="blog-detail.html">
         ...
         <img class="aspect__img" src="{{ asset('user_app/assets/images/blog/post_12.jpg')}}" alt=""></a>
        <!--====== End - Image Code ======-->
       </div>
       <div class="bp-mini__content">
        <!-- <div class="bp-mini__stat">
      ...
      <div class="bp-mini bp-mini--img u-h-100">
       <div class="bp-mini__thumbnail">
        ...
        <a class="aspect aspect--bg-grey aspect--1366-768 u-d-block" href="blog-detail.html">
         ...
         <img class="aspect__img" src="{{ asset('user_app/assets/images/blog/post_5.jpg')}}" alt=""></a>
        <!--====== End - Image Code ======-->
       </div>
       <!-- <div class="bp-mini__content">
                                        <div class="bp-mini__stat">
