     ...
     <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
      ...
      <a class="promotion" href="shop-side-version-2.html">
       <div class="aspect aspect--bg-grey aspect--square">
        ...
        <img class="aspect__img promotion__img" src="{{ asset('user_app/assets/images/promo/promo_1.jpg')}}" alt="">
       </div>
     ...
     <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
      ...
      <a class="promotion" href="shop-side-version-2.html">
       <div class="aspect aspect--bg-grey aspect--square">
        ...
        <img class="aspect__img promotion__img" src="{{ asset('user_app/assets/images/promo/promo_2.jpg')}}" alt="">
       </div>
       <div class="promotion__content">
        <div class="promotion__text-wrap">
         <div class="promotion__text-1">
     ...
     <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
      ...
      <a class="promotion" href="shop-side-version-2.html">
       <div class="aspect aspect--bg-grey aspect--square">
        ...
        <img class="aspect__img promotion__img" src="{{ asset('user_app/assets/images/promo/promo_3.jpg')}}" alt="">
       </div>
       <div class="promotion__content">
        <div class="promotion__text-wrap">
         <div class="promotion__text-1">
