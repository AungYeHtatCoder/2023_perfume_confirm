     ...
     <div class="col-lg-12">
      <div class="filter-category-container">
       ...
       <div class="filter__category-wrapper">
        ...
        <button class="btn filter__btn filter__btn--style-1" type="button" data-filter=".headphone">MEN RANGE</button>
       </div>
       <div class="filter__category-wrapper">

        <button class="btn filter__btn filter__btn--style-1" type="button" data-filter=".smartphone">WOMEN
         RANGE</button>
       </div>
       <!-- <div class="filter__category-wrapper">

                                        <button class="btn filter__btn filter__btn--style-1" type="button" data-filter=".sportgadget">UNISEX RANGE</button>
                                        </div> -->
       <!-- <div class="filter__category-wrapper">

                                        <button class="btn filter__btn filter__btn--style-1" type="button" data-filter=".dslr">SOFT SCENT</button>
                                    </div> -->
      </div>
           ...
           <div class="product-o__action-wrap">
            <ul class="product-o__action-list">
             ...
             <li>
              ...
              <a data-modal="modal" data-modal-id="#add-to-cart" class="add-to-cart-button" data-tooltip="tooltip"
         ...
         <div class="product-o product-o--hover-on product-o--radius">
          <div class="product-o__wrap">
           ...
           <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.html">
            ...
            <img class="aspect__img" src="{{ asset('user_app/assets/images/product/electronic/product_25.jfif')}}"
             alt=""></a>
           <div class="product-o__action-wrap">
            <ul class="product-o__action-list">
             <li>
