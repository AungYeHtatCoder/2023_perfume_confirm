       ...
       <div class="pd-wrap">
        <div id="js-product-detail-modal">
         <div>
          ...
          <img class="u-img-fluid" src="{{ asset('user_app/assets/images/product/product-d-1.jpg')}}" alt="">
         </div>
         <div>

          <img class="u-img-fluid" src="{{ asset('user_app/assets/images/product/product-d-2.jpg')}}" alt="">
         </div>
         <div>

          <img class="u-img-fluid" src="{{ asset('user_app/assets/images/product/product-d-3.jpg')}}" alt="">
         </div>
         <div>

          <img class="u-img-fluid" src="{{ asset('user_app/assets/images/product/product-d-4.jpg')}}" alt="">
         </div>
         <div>

          <img class="u-img-fluid" src="{{ asset('user_app/assets/images/product/product-d-5.jpg')}}" alt="">
         </div>
        </div>
       </div>
     ...
     <div class="col-lg-7">
      ...
      <div class="pd-detail">
       ...
       <div class="u-s-m-b-15">
        ...
        <span class="pd-detail__preview-desc">Lorem Ipsum is simply dummy text of the printing and typesetting
